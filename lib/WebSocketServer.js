...
import { eventEmitterListenerCount } from './utils.js';
import { inherits } from 'util';
import _debug from '../vendor/debug/index.js';
var debug = _debug('websocket:server');
import { EventEmitter } from 'events';
import WebSocketRequest from './WebSocketRequest.js';
import { setImmediateImpl } from './utils.js';
...
WebSocketServer.prototype.handleUpgrade = function(request, socket) {
    ...
    if (!this.config.autoAcceptConnections && eventEmitterListenerCount(this, 'request') > 0) {
